...
type NotificationServiceClient interface {
	GetUserNotifications(ctx context.Context, in *UserNotificationRequest, opts ...grpc.CallOption) (*UserNotificationResponse, error)
...
func (c *notificationServiceClient) GetUserNotifications(ctx context.Context, in *UserNotificationRequest, opts ...grpc.CallOption) (*UserNotificationResponse, error) {
...
type NotificationServiceServer interface {
	GetUserNotifications(context.Context, *UserNotificationRequest) (*UserNotificationResponse, error)
...
func (UnimplementedNotificationServiceServer) GetUserNotifications(context.Context, *UserNotificationRequest) (*UserNotificationResponse, error) {
...
func _NotificationService_GetUserNotifications_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).GetUserNotifications(ctx, req.(*UserNotificationRequest))
	}
