...
const file_loan_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"loan.proto\x12\x04loan\"\xbb\x02\n" +
	"\vLoanRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x04R\x06userId\x12\x10\n" +
	"\x03ssn\x18\x02 \x01(\tR\x03ssn\x12!\n" +
	"\faddress_area\x18\x03 \x01(\tR\vaddressArea\x12\x1f\n" +
	"\vloan_amount\x18\x04 \x01(\x01R\n" +
	"loanAmount\x12!\n" +
	"\floan_purpose\x18\x05 \x01(\tR\vloanPurpose\x12+\n" +
	"\x11employment_status\x18\x06 \x01(\tR\x10employmentStatus\x120\n" +
	"\x14gross_monthly_income\x18\a \x01(\x01R\x12grossMonthlyIncome\x12;\n" +
	"\x1atotal_monthly_debt_payment\x18\b \x01(\x01R\x17totalMonthlyDebtPayment\"?\n" +
	...
	"\aloan_id\x18\x01 \x01(\x04R\x06loanId\"\xae\x05\n" +
	"\x17LoanApplicationResponse\x12\x17\n" +
	"\aloan_id\x18\x01 \x01(\x04R\x06loanId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\x04R\x06userId\x12\x10\n" +
	"\x03ssn\x18\x03 \x01(\tR\x03ssn\x12!\n" +
	"\faddress_area\x18\x04 \x01(\tR\vaddressArea\x12\x1f\n" +
	"\vloan_amount\x18\x05 \x01(\x01R\n" +
	"loanAmount\x12!\n" +
	"\floan_purpose\x18\x06 \x01(\tR\vloanPurpose\x12+\n" +
	"\x11employment_status\x18\a \x01(\tR\x10employmentStatus\x120\n" +
	"\x14gross_monthly_income\x18\b \x01(\x01R\x12grossMonthlyIncome\x12;\n" +
	"\x1atotal_monthly_debt_payment\x18\t \x01(\x01R\x17totalMonthlyDebtPayment\x12\x1b\n" +
	"\tdti_ratio\x18\n" +
	" \x01(\x01R\bdtiRatio\x12-\n" +
	"\x12application_status\x18\v \x01(\tR\x11applicationStatus\x122\n" +
	"\x15credit_report_fetched\x18\f \x01(\bR\x13creditReportFetched\x12.\n" +
	"\x13experian_request_id\x18\r \x01(\tR\x11experianRequestId\x12!\n" +
	"\fcredit_score\x18\x0e \x01(\x05R\vcreditScore\x12\x1c\n" +
	"\treasoning\x18\x0f \x01(\tR\treasoning\x12\x1d\n" +
	"\n" +
	"created_at\x18\x10 \x01(\tR\tcreatedAt\x12\x1d\n" +
	"\n" +
	"updated_at\x18\x11 \x01(\tR\tupdatedAt\x12\x1d\n" +
	"\n" +
	"deleted_at\x18\x12 \x01(\tR\tdeletedAt\"\a\n" +
	"\x05Empty\"X\n" +
