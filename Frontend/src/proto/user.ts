...
export const RegisterRequest: MessageFns<RegisterRequest> = {
  encode(message: RegisterRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.dateOfBirth !== undefined) {
      Timestamp.encode(message.dateOfBirth, writer.uint32(42).fork()).join();
    }
    if (message.address !== "") {
...
export const UserDetailsResponse: MessageFns<UserDetailsResponse> = {
  encode(message: UserDetailsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.dateOfBirth !== undefined) {
      Timestamp.encode(message.dateOfBirth, writer.uint32(34).fork()).join();
    }
    if (message.address !== "") {
...
export const userList: MessageFns<userList> = {
  encode(message: userList, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.users) {
      UserDetailsResponse.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.users.push(UserDetailsResponse.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): userList {
    return {
      users: globalThis.Array.isArray(object?.users)
        ? object.users.map((e: any) => UserDetailsResponse.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: userList): unknown {
    ...
    if (message.users?.length) {
      obj.users = message.users.map((e) => UserDetailsResponse.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<userList>, I>>(object: I): userList {
    const message = createBaseuserList();
    message.users = object.users?.map((e) => UserDetailsResponse.fromPartial(e)) || [];
    return message;
  },
};
...
export interface UserService {
  ...
  UpdateUserDetails(request: DeepPartial<UserUpdateRequest>, metadata?: grpc.Metadata): Promise<UserUpdateResponse>;
  GetUserCreditScore(
    request: DeepPartial<UserCreditScoreRequest>,
    metadata?: grpc.Metadata,
  ): Promise<UserCreditScoreResponse>;
  GetAllUsers(request: DeepPartial<Empty>, metadata?: grpc.Metadata): Promise<userList>;
}
...
export const UserServiceUpdateUserDetailsDesc: UnaryMethodDefinitionish = {
  ...
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = UserUpdateResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export const UserServiceGetAllUsersDesc: UnaryMethodDefinitionish = {
  ...
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = userList.decode(data);
      return {
        ...value,
        toObject() {
          return value;
